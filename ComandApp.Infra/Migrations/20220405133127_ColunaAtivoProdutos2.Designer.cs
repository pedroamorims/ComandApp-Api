...
namespace ComandApp.Infra.Migrations
{
    ...
    [Migration("20220405133127_ColunaAtivoProdutos2")]
    partial class ColunaAtivoProdutos2
    {
            ...
            modelBuilder.Entity("ComandApp.Domain.Entitities.ComandaProduto", b =>
                {
                    ...
                    b.Property<DateTime>("DataPedido")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 5, 10, 31, 27, 632, DateTimeKind.Local).AddTicks(2522));
            ...
            modelBuilder.Entity("ComandApp.Domain.Entitities.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("SMALLDATETIME")
                        .HasDefaultValue(new DateTime(2022, 4, 5, 10, 31, 27, 632, DateTimeKind.Local).AddTicks(4517));
            ...
            modelBuilder.Entity("ComandApp.Domain.Entitities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("SMALLDATETIME")
                        .HasDefaultValue(new DateTime(2022, 4, 5, 13, 31, 27, 632, DateTimeKind.Utc).AddTicks(8670));

                    b.Property<DateTime>("DataCriacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("SMALLDATETIME")
                        .HasDefaultValue(new DateTime(2022, 4, 5, 13, 31, 27, 632, DateTimeKind.Utc).AddTicks(8430));
